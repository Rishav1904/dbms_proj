...
const registerAdmin = async (req, res) => {
    try {
        ...
        const {name, email, father_name, contact, address, dob, aadhar_no, hostel, password} = req.body;
...
const updateAdmin = async (req, res) => {
    try {
        ...
        const {name, email, father_name, contact, address, dob, aadhar_no} = req.body;
