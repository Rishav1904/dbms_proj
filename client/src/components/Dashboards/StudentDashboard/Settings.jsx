  ...
  return (
    <div className="w-full h-screen pt-20 flex flex-col items-center justify-center">
      ...
      <form method="POST" onSubmit={changePassword} >
        <div className="w-96 flex flex-col justify-between gap-5 bg-primary p-5 rounded-lg shadow-xl">
          ...
          <button
            type="submit"
            className="w-full text-white bg-accent hover:bg-accent-hover focus:ring-4 focus:outline-none focus:ring-accent/50 font-medium rounded-lg text-sm px-5 py-2.5 mt-5 text-center transition-all duration-300"
          >
            Change Password
          </button>
          <ToastContainer
